...
class TanhLossLRQAR(object):
    ...
    def __format__(self, format_spec):
        return 'tanh_loss_lr_qar'

    def __call__(self, w):
        return ds.tanh_loss_lr(w, self.x, self.y)
...
class Experiments(object):
    ...
    def __init__(self, start, end):
        ...
        tanh_loss_lr_pdc = TanhLossLRPDC()
        tanh_loss_lr_shd = TanhLossLRSHD()
        tanh_loss_lr_c = TanhLossLRC()
        tanh_loss_lr_m = TanhLossLRM()
        tanh_loss_lr_qar = TanhLossLRQAR()
        self.functions = [tanh_loss_lr_pdc,
                          tanh_loss_lr_shd,
                          tanh_loss_lr_c,
                          tanh_loss_lr_m,
                          tanh_loss_lr_qar]
        self.ndim_problem = [tanh_loss_lr_pdc.x.shape[1] + 1,
                             tanh_loss_lr_shd.x.shape[1] + 1,
                             tanh_loss_lr_c.x.shape[1] + 1,
                             tanh_loss_lr_m.x.shape[1] + 1,
                             tanh_loss_lr_qar.x.shape[1] + 1]
