...
class LossMarginPerceptronQAR(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'loss_margin_perceptron_qar'

    def __call__(self, w):
        return ds.loss_margin_perceptron(w, self.x, self.y)


class LossMarginPerceptronM(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'loss_margin_perceptron_m'

    def __call__(self, w):
        return ds.loss_margin_perceptron(w, self.x, self.y)


class LossMarginPerceptronC(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'loss_margin_perceptron_c'

    def __call__(self, w):
        return ds.loss_margin_perceptron(w, self.x, self.y)


class LossMarginPerceptronSHD(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'loss_margin_perceptron_shd'

    def __call__(self, w):
        return ds.loss_margin_perceptron(w, self.x, self.y)


class LossMarginPerceptronPDC(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'loss_margin_perceptron_pdc'
...
class Experiments(object):
    ...
    def __init__(self, start, end):
        ...
        loss_margin_perceptron_pdc = LossMarginPerceptronPDC()
        loss_margin_perceptron_shd = LossMarginPerceptronSHD()
        loss_margin_perceptron_c = LossMarginPerceptronC()
        loss_margin_perceptron_m = LossMarginPerceptronM()
        loss_margin_perceptron_qar = LossMarginPerceptronQAR()
        self.functions = [loss_margin_perceptron_pdc,
                          loss_margin_perceptron_shd,
                          loss_margin_perceptron_c,
                          loss_margin_perceptron_m,
                          loss_margin_perceptron_qar]
        self.ndim_problem = [loss_margin_perceptron_pdc.x.shape[1] + 1,
                             loss_margin_perceptron_shd.x.shape[1] + 1,
                             loss_margin_perceptron_c.x.shape[1] + 1,
                             loss_margin_perceptron_m.x.shape[1] + 1,
                             loss_margin_perceptron_qar.x.shape[1] + 1]
