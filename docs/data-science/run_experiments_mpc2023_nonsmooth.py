...
class MPC2023NonsmoothQAR(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'mpc2023_nonsmooth_qar'

    def __call__(self, w):
        return ds.mpc2023_nonsmooth(w, self.x, self.y)


class MPC2023NonsmoothM(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'mpc2023_nonsmooth_m'

    def __call__(self, w):
        return ds.mpc2023_nonsmooth(w, self.x, self.y)


class MPC2023NonsmoothC(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'mpc2023_nonsmooth_c'

    def __call__(self, w):
        return ds.mpc2023_nonsmooth(w, self.x, self.y)


class MPC2023NonsmoothSHD(object):
    def __init__(self):
    ...
    def __format__(self, format_spec):
        return 'mpc2023_nonsmooth_shd'

    def __call__(self, w):
        return ds.mpc2023_nonsmooth(w, self.x, self.y)


class MPC2023NonsmoothPDC(object):
    def __init__(self):
...
class Experiments(object):
    ...
    def __init__(self, start, end):
        ...
        mpc2023_nonsmooth_pdc = MPC2023NonsmoothPDC()
        mpc2023_nonsmooth_shd = MPC2023NonsmoothSHD()
        mpc2023_nonsmooth_c = MPC2023NonsmoothC()
        mpc2023_nonsmooth_m = MPC2023NonsmoothM()
        mpc2023_nonsmooth_qar = MPC2023NonsmoothQAR()
        self.functions = [mpc2023_nonsmooth_pdc,
                          mpc2023_nonsmooth_shd,
                          mpc2023_nonsmooth_c,
                          mpc2023_nonsmooth_m,
