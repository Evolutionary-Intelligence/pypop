...
```bash
nohup python run_experiments.py -s=1 -e=1 -o=CEP >CEP_1_1.out 2>&1 &
nohup python run_experiments.py -s=2 -e=2 -o=CEP >CEP_2_2.out 2>&1 &
nohup python run_experiments.py -s=3 -e=3 -o=CEP >CEP_3_3.out 2>&1 &
nohup python run_experiments.py -s=4 -e=4 -o=CEP >CEP_4_4.out 2>&1 &
nohup python run_experiments.py -s=5 -e=5 -o=CEP >CEP_5_5.out 2>&1 &
nohup python run_experiments.py -s=6 -e=6 -o=CEP >CEP_6_6.out 2>&1 &
nohup python run_experiments.py -s=7 -e=7 -o=CEP >CEP_7_7.out 2>&1 &
...
```bash
nohup python run_experiments.py -s=1 -e=10 -o=CEP >CEP_1_10.out 2>&1 &
```
