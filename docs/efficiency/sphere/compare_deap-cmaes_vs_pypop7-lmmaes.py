...
if __name__ == '__main__':
    ...
    plt.savefig('./figs/compare_deap-cmaes_vs_pypop7-lmmaes[cost].eps')
    # plt.show()
    ...
    ax1.set_yticks([0e7, 0.5e7, 1.0e7, 1.5e7, 2.0e7],
                   ['0e7', '0.5e7', '1.0e7', '1.5e7', '2.0e7'],
                   fontsize=30, fontweight='bold')
    ...
    ax2.set_yticks(np.arange(0, 200, 20), np.arange(0, 200, 20), fontsize=30, fontweight='bold')
    plt.title('Sphere', fontsize=30, fontweight='bold')
    plt.savefig('./figs/compare_deap-cmaes_vs_pypop7-lmmaes[fe].eps')
    # plt.show()
