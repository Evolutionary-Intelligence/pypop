"""Compare computational efficiency between *DEAP (RES)* and *PYPOP7 (RES)*
...
def read_pickle(s, ii):
    with open(os.path.join('./docs/efficiency/sphere', s + '-RES_' + ii + '.pickle'), 'rb') as handle:
