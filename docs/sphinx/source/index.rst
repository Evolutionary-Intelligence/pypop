...
population-based optimizers (including evolutionary algorithms, swarm-based random methods,
and pattern search)*, in order to facilitate research repeatability, benchmarking of BBO, and
