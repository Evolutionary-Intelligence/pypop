...
def shi_cd(x):  # from https://arxiv.org/abs/1610.00040
...
class MAES1(MAES):
    def optimize(self, fitness_function=None, args=None):  # for all generations (iterations)
        ...
        x_data, mean_data = [], []  # for plotting
        x = np.empty((self.n_individuals, self.ndim_problem))  # for plotting
        while True:
