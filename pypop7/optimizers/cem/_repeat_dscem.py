"""Repeat the following paper for `DSCEM`:
    ...
    Luckily our code could repeat the data generated by the original Matlab code *well*.
    Therefore, we argue that the repeatability of `DSCEM` could be **well-documented**.
...
if __name__ == '__main__':
    ...
    print(results)  # 1.79453493e+08 vs 234513028.88791963 (from the Matlab code)
