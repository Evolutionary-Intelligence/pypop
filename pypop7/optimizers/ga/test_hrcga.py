...
from pypop7.benchmarks.base_functions import rastrigin, schwefel12, sphere
from pypop7.optimizers.ga.hrcga import HRCGA as Solver


class TestHRCGA(unittest.TestCase):
    def test_optimize(self):
        start_run = time.time()
        ndim_problem = 25
        for f in [rastrigin, schwefel12, sphere]:
