"""Repeat the following paper for `LMCMAES`:
    ...
    Line 1616 `bool sample_symmetry=false` to `bool sample_symmetry=true` for success.
    Then you can run the following command (if using Windows OS).
...
if __name__ == '__main__':
    ...
    for f in [ellipsoid]:
        ...
        print(results)  # vs 4893900 (from the C++ code)
