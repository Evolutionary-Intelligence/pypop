"""
    Repeat Fig. 4 (Sphere, Cigar, Tablet(Discus),Ellipsoid N=3 and N=30) from the following paper:
...
def plot(function, dimension):
    plt.figure()
    result = read_pickle(function, dimension)
    print(result)
    plt.yscale('log')
    ...
    plt.title(function.capitalize() + " N = " + str(dimension))
    plt.show()
