...
class CMAES(ES):
    ...
    .. note:: `CMAES` is widely recognized as one of **State-Of-The-Art (SOTA)** evolutionary algorithms for continuous
       ...
       <https://arxiv.org/abs/2403.17009>`_, `[Martin, 2024, Ph.D. Dissertation (Harvard University)]
       ...
       <https://www.nature.com/articles/s41467-021-22017-2>`_, `[Barkley, 2021, Ph.D. Dissertation (Harvard University)]
       <https://dash.harvard.edu/handle/1/37368472>`_, `[Lei, 2020, Ph.D. Dissertation (University of Oxford)]
