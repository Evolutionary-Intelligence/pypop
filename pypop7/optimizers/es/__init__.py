...
from pypop7.optimizers.es.vkdcma import VKDCMA  # Restricted Covariance Matrix Adaptation (2016)
...
__all__ = [ES,  # base (abstract) class
           ...
           SEPCMAES, VDCMA, LMCMAES, VKDCMA, LMCMA, R1ES, RMES, LMMAES, FCMAES, MMES]  # especially for large-scale BBO
