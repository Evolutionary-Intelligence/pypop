...
class Test(unittest.TestCase):
    ...
    def test_Discus(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [4000004, 1000001, 0, 1000001, 4000004]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 2, x2))
        x3 = [4000008, 1000002, 0, 1000002, 4000008]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 3, x3))
        x4 = [0, 1000003, 1000003, 1000003, 1000029, 1000029, 16000014]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 4, x4))
        x5 = [0, 1000004, 1000004, 1000004, 1000054, 1000054, 25000030]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 5, x5))
        x6 = [0, 1000005, 1000005, 1000005, 1000090, 1000090, 36000055]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 6, x6))
        x7 = [0, 1000006, 1000006, 1000006, 1000139, 1000139, 49000091, 91]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(discus_object, 1, np.empty((5,)))
        self.assertTrue(rotated_shifted_sample.check_origin(discus_object))
    ...
    def test_CigarDiscus(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [4080004, 1020001, 0, 1020001, 4080004]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 2, x2))
        x3 = [4040004, 1010001, 0, 1010001, 4040004]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 3, x3))
        x4 = [0, 1020001, 1020001, 1020001, 16130001, 16130001, 1130016]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 4, x4))
        x5 = [0, 1030001, 1030001, 1030001, 25290001, 25290001, 1290025]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 5, x5))
        x6 = [0, 1040001, 1040001, 1040001, 36540001, 36540001, 1540036]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 6, x6))
        x7 = [0, 1050001, 1050001, 1050001, 49900001, 49900001, 1900049, 36550000]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(cigar_discus_object, 1, np.empty((5,)))
        self.assertTrue(rotated_shifted_sample.check_origin(cigar_discus_object))
    ...
    def test_Ellipsoid(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [4000004, 1000001, 0, 1000001, 4000004]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 2, x2))
        x3 = [4004004, 1001001, 0, 1001001, 4004004]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 3, x3))
        x4 = [0, 1010101, 1010101, 1010101, 16090401, 16090401, 1040916]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 4, x4))
        x5 = [0, 1032655, 1032655, 1032655, 25515092, 25515092, 1136022]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 5, x5))
        x6 = [0, 1067345, 1067345, 1067345, 37643416, 37643416, 1292664]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 6, x6))
        x7 = [0, 1111111, 1111111, 1111111, 52866941, 52866941, 1508909, 38669410]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(ellipsoid_object, 1, np.empty((5,)))
        self.assertTrue(rotated_shifted_sample.check_origin(ellipsoid_object))
    ...
    def test_DifferentPowers(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [68, 2, 0, 2, 68]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 2, x2))
        x3 = [84, 3, 0, 3, 84]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 3, x3))
        x4 = [0, 4, 4, 4, 4275.6, 4275.6, 81.3]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 4, x4, 0.1))
        x5 = [0, 5, 5, 5, 16739, 16739, 203]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 5, x5))
        x6 = [0, 6, 6, 6, 51473.5, 51473.5, 437.1]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 6, x6, 0.1))
        x7 = [0, 7, 7, 7, 133908.7, 133908.7, 847.4, 52736.8]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 7, x7, 0.1))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(different_powers_object, 1, np.empty((5,)))
        self.assertTrue(rotated_shifted_sample.check_origin(different_powers_object))
    ...
    def test_Schwefel221(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x1 = [2, 1, 0, 1, 2]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 1, x1))
        x2 = [2, 1, 0, 1, 2]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 2, x2))
        x3 = [2, 1, 0, 1, 2]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 3, x3))
        x4 = [0, 1, 1, 1, 4, 4, 4]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 4, x4))
        x5 = [0, 1, 1, 1, 5, 5, 5]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 5, x5))
        x6 = [0, 1, 1, 1, 6, 6, 6]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 6, x6))
        x7 = [0, 1, 1, 1, 7, 7, 7, 6]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel221_object, 7, x7))
        self.assertTrue(rotated_shifted_sample.check_origin(schwefel221_object))
    ...
    def test_Rosenbrock(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [409, 4, 1, 0, 401]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 2, x2))
        x3 = [810, 4, 2, 400, 4002]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 3, x3))
        x4 = [3, 0, 1212, 804, 2705, 17913, 24330]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 4, x4))
        x5 = [4, 0, 1616, 808, 14814, 30038, 68450]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 5, x5))
        x6 = [5, 0, 2020, 808, 50930, 126154, 164579]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 6, x6))
        x7 = [6, 0, 2424, 1208, 135055, 210303, 349519, 51031]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(rosenbrock_object, 1, np.empty((5,)))
    ...
    def test_Schwefel12(self):
        ...
        rotated_shifted_sample = RotatedShiftedSample()
        x2 = [4, 1, 0, 5, 20]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 2, x2))
        x3 = [8, 2, 0, 6, 24]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 3, x3))
        x4 = [0, 30, 30, 2, 146, 10, 18]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 4, x4))
        x5 = [0, 55, 55, 3, 371, 19, 55]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 5, x5))
        x6 = [0, 91, 91, 7, 812, 28, 195]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 6, x6))
        x7 = [0, 140, 140, 8, 1596, 44, 564, 812]
        self.assertTrue(rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_shifted_sample.compare_rotated_shifted_func_values(schwefel12_object, 1, np.empty((5,)))
        self.assertTrue(rotated_shifted_sample.check_origin(schwefel12_object))
