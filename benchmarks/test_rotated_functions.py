...
class Test(unittest.TestCase):
    ...
    def test_Cigar(self):
        ...
        rotated_sample = RotatedSample()
        x2 = [4000004, 1000001, 0, 1000001, 4000004]
        self.assertTrue(rotated_sample.compare_rotated_func_values(cigar_object, 2, x2))
        x3 = [8000004, 2000001, 0, 2000001, 8000004]
        self.assertTrue(rotated_sample.compare_rotated_func_values(cigar_object, 3, x3))
        x4 = [0, 3000001, 3000001, 3000001, 29000001, 29000001, 14000016]
        self.assertTrue(rotated_sample.compare_rotated_func_values(cigar_object, 4, x4))
        x5 = [0, 4000001, 4000001, 4000001, 54000001, 54000001, 30000025]
        self.assertTrue(rotated_sample.compare_rotated_func_values(cigar_object, 5, x5))
        x6 = [0, 5000001, 5000001, 5000001, 90000001, 90000001, 55000036]
        self.assertTrue(rotated_sample.compare_rotated_func_values(cigar_object, 6, x6))
        x7 = [0, 6000001, 6000001, 6000001, 139000001, 139000001, 91000049, 91000000]
    ...
    def test_Discus(self):
        ...
        rotated_sample = RotatedSample()
        x2 = [4000004, 1000001, 0, 1000001, 4000004]
        self.assertTrue(rotated_sample.compare_rotated_func_values(discus_object, 2, x2))
        x3 = [4000008, 1000002, 0, 1000002, 4000008]
        self.assertTrue(rotated_sample.compare_rotated_func_values(discus_object, 3, x3))
        x4 = [0, 1000003, 1000003, 1000003, 1000029, 1000029, 16000014]
        self.assertTrue(rotated_sample.compare_rotated_func_values(discus_object, 4, x4))
        x5 = [0, 1000004, 1000004, 1000004, 1000054, 1000054, 25000030]
        self.assertTrue(rotated_sample.compare_rotated_func_values(discus_object, 5, x5))
        x6 = [0, 1000005, 1000005, 1000005, 1000090, 1000090, 36000055]
        self.assertTrue(rotated_sample.compare_rotated_func_values(discus_object, 6, x6))
        x7 = [0, 1000006, 1000006, 1000006, 1000139, 1000139, 49000091, 91]
    ...
    def test_DifferentPowers(self):
        ...
        rotated_sample = RotatedSample()
        x2 = [68, 2, 0, 2, 68]
        self.assertTrue(rotated_sample.compare_rotated_func_values(different_powers_object, 2, x2))
        x3 = [84, 3, 0, 3, 84]
        self.assertTrue(rotated_sample.compare_rotated_func_values(different_powers_object, 3, x3))
        x4 = [0, 4, 4, 4, 4275.6, 4275.6, 81.3]
        self.assertTrue(rotated_sample.compare_rotated_func_values(different_powers_object, 4, x4, 0.1))
        x5 = [0, 5, 5, 5, 16739, 16739, 203]
        self.assertTrue(rotated_sample.compare_rotated_func_values(different_powers_object, 5, x5))
        x6 = [0, 6, 6, 6, 51473.5, 51473.5, 437.1]
        self.assertTrue(rotated_sample.compare_rotated_func_values(different_powers_object, 6, x6, 0.1))
        x7 = [0, 7, 7, 7, 133908.7, 133908.7, 847.4, 52736.8]
    ...
    def test_Rosenbrock(self):
        ...
        rotated_sample = RotatedSample()
        x2 = [409, 4, 1, 0, 401]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 2, x2))
        x3 = [810, 4, 2, 400, 4002]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 3, x3))
        x4 = [3, 0, 1212, 804, 2705, 17913, 24330]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 4, x4))
        x5 = [4, 0, 1616, 808, 14814, 30038, 68450]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 5, x5))
        x6 = [5, 0, 2020, 808, 50930, 126154, 164579]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 6, x6))
        x7 = [6, 0, 2424, 1208, 135055, 210303, 349519, 51031]
        self.assertTrue(rotated_sample.compare_rotated_func_values(rosenbrock_object, 7, x7))
        with self.assertRaisesRegex(TypeError, 'The size should > 1+'):
            rotated_sample.compare_rotated_func_values(rosenbrock_object, 1, np.empty((5,)))
