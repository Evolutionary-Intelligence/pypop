...
[![WeChat-Group](https://img.shields.io/badge/WeChat-green)](docs/logo/WeChatGroupTo20241103.jpg)
...
*elegant* algorithmic implementations (e.g., evolutionary algorithms, swarm-based optimizers, and
pattern search) for **Black-Box Optimization (BBO)**, *particularly population-based optimizers*,
...
* **Random Search (RS)**
  ...
  * Bergstra, J. and Bengio, Y., 2012. [Random search for hyper-parameter optimization](https://www.jmlr.org/papers/v13/bergstra12a.html). JMLR, 13(2).
...
(Now it has been submitted to [JMLR](https://jmlr.org/), after 3 reviews from Tue, 28 Mar 2023 to Wed, 01 Nov
